...
{
    public interface ICameraModelObserver:IModelObserver, IBaseTransformModelObserver
    {
        Vector3 Distance { get; }
        Vector3 LookAtPosition { get; }
    }

    public interface ICameraModel:ICameraModelObserver, IBaseTransformModel
    {
